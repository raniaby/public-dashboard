<#macro userProfileFormFields>
	...
	<#list profile.attributes as attribute>
		...
		<div class="${properties.kcFormGroupClass!} custom_container_card_email_input_container custom_container_card_email_input_container_email_register">
			<div class="${properties.kcLabelWrapperClass!}">
				<label for="${attribute.name}" class="${properties.kcLabelClass!} custom_container_card_email_input_label">${advancedMsg(attribute.displayName!'')}</label>
			</div>
			...
			<#--  <#if messagesPerField.existsError('${attribute.name}')>
				<span class="${properties.kcInputErrorMessageClass!} custom_container_card_input_error" id="input-error-${attribute.name}" class="${properties.kcInputErrorMessageClass!}" aria-live="polite">
...
<#macro inputTag attribute value>
	<input  tabindex="1" type="<@inputTagType attribute=attribute/>" id="${attribute.name}" name="${attribute.name}" value="${(value!'')}" class="${properties.kcInputClass!}"
